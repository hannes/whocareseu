...
function SimpleMapD3(o) {
  ...
  smd.drawMap = function() {
    ...
    smd.featureGroup
      ...
      .enter().append('path')
        // added by hannes@muehleisen.org to color the elements again.
        .attr('feature-id', function(d) {return d.id})
        // end of changes
        .attr('d', smd.projPath)
        .attr('class', 'smd-path')
        ...
        });/* removed by hannes@muehleisen.org to make tooltip sticky
